                                                                  ...
                                                                  child: Column(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      StreamBuilder<
                                                                        ...
                                                                        stream:
                                                                            querySkillsRecord(
                                                                          queryBuilder: (skillsRecord) => skillsRecord
                                                                              .where(
                                                                                'category',
                                                                                isEqualTo: listViewSkillsetRecord.reference,
                                                                              )
                                                                              .orderBy('sort_index'),
                                                                        ),
                                                                        builder:
