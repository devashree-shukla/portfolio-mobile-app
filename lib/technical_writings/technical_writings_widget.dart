...
import 'technical_writings_model.dart';
export 'technical_writings_model.dart';

class TechnicalWritingsWidget extends StatefulWidget {
  const TechnicalWritingsWidget({super.key});

  @override
  State<TechnicalWritingsWidget> createState() =>
      _TechnicalWritingsWidgetState();
}

class _TechnicalWritingsWidgetState extends State<TechnicalWritingsWidget>
    with TickerProviderStateMixin {
  late TechnicalWritingsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TechnicalWritingsModel());
