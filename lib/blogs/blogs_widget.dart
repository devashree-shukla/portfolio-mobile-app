                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ClipRRect(
                                      borderRadius: BorderRadius.circular(8.0),
                                      child: Image.asset(
                                        'assets/images/DALLE_feature.png',
                                        width: double.infinity,
                                        height: 160.0,
                                        fit: BoxFit.cover,
                                      ),
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        Expanded(
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              'ohos4ckm' /* I've been writing blog posts r... */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .labelMedium
                                                .override(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        Expanded(
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              'cguwmh2c' /* Whenever i'm in a creative zon... */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .labelMedium
                                                .override(
                                    ...
                                    Padding(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          context.pushNamed('CreativeWritings');
                                        },
                                        text:
                                            FFLocalizations.of(context).getText(
                                          '8kvtch6h' /* View List */,
