                ...
                children: [
                  ...
                  Expanded(
                    child: StreamBuilder<List<OrganizationRecord>>(
                      stream: FFAppState().loadCompanies(
                        requestFn: () => queryOrganizationRecord(
                          queryBuilder: (organizationRecord) =>
                              organizationRecord.orderBy(
                      ...
                      builder: (context, snapshot) {
                        ...
                        List<OrganizationRecord>
                            listViewOrganizationRecordList = snapshot.data!;
                        return ListView.builder(
                          padding: EdgeInsets.zero,
                          primary: false,
                          scrollDirection: Axis.vertical,
                          itemCount: listViewOrganizationRecordList.length,
                                              ...
                                              Padding(
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text(
                                                      '${listViewOrganizationRecord.location}  ,  ${listViewOrganizationRecord.roleType}',
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                                              .bodySmall
